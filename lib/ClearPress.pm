#########
# Author:        rmp
# Last Modified: $Date: 2008-06-13 20:50:39 +0100 (Fri, 13 Jun 2008) $ $Author: zerojinx $
# Id:            $Id: ClearPress.pm 173 2008-06-13 19:50:39Z zerojinx $
...
our $VERSION = do { my ($r) = q$Revision: 173 $ =~ /(\d+)/mx; $r; };
