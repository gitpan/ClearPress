#########
# Author:        rmp
# Last Modified: $Date: 2008-11-14 14:07:06 +0000 (Fri, 14 Nov 2008) $ $Author: zerojinx $
# Id:            $Id: ClearPress.pm 279 2008-11-14 14:07:06Z zerojinx $
...
our $VERSION = do { my ($r) = q$Revision: 279 $ =~ /(\d+)/smx; $r; };
